...
function render() {
    ...
    drawPolygon(shapeA, 'rgba(0, 0, 255, 0.5)', true); // Blue square
    drawPolygon(shapeB, 'rgba(0, 128, 0, 0.5)', true); // Green wedge

    // Calculate and draw the Morphed Shape!
    const currentShape = getMorphedShape(t);
    drawPolygon(currentShape, 'red', false, 'rgba(255, 0, 0, 0.2)'); // Solid red with fill
}
